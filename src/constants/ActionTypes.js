...
export const GET_USER_SUCCESS = '@@contacts/GET_USER_SUCCESS';
export const GET_USER_FAILURE = '@@contacts/GET_USER_FAILURE';

export const GET_CHATS_REQUEST = '@@contacts/GET_CHATS_REQUEST';
export const GET_CHATS_SUCCESS = '@@contacts/GET_CHATS_SUCCESS';
export const GET_CHATS_FAILURE = '@@contacts/GET_CHATS_FAILURE';

export const GET_MESSAGES_REQUEST = '@@contacts/GET_MESSAGES_REQUEST';
export const GET_MESSAGES_SUCCESS = '@@contacts/GET_MESSAGES_SUCCESS';
export const GET_MESSAGES_FAILURE = '@@contacts/GET_MESSAGES_FAILURE';
